...
%=======================================================
% Make cover-page
\thesistitle{Quantum Droplet in a Mixture of Rb and Na Bose-Einstein Condensates}
...
\submitdate{January 2022}
\committee{
	Professor XU, Lei (Chair)\\
	Professor WANG, Dajun (Thesis Supervisor)\\
	Professor LAW, Chi Kwong (Committee Member)\\
...
\input{sections/Ch2_Theory}
\input{sections/Ch3_Apparatus}
\input{sections/Ch4_Feshbach}
\input{sections/Ch5_Droplet}
%\input{sections/Ch6_Low dimension droplet}
\input{sections/Ch7_Conclusion}
...
\appendix
\input{sections/S1_M&E_schematic}
%\input{sections/S2_eGPELAB}
%\input{sections/S3_MOLSCAT}
\input{sections/S4-Camera&SNR-AbsoptionImage.tex}
\newpage
\setstretch{1}
