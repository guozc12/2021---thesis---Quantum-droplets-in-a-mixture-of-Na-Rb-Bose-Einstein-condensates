...
%Why we need to compensate the B-field gradient (done 2021-9-17 22:27:44)
...
% add free falling atom under high magnetic field
\begin{figure}[htbp]
\begin{center}
\includegraphics [width = \linewidth]{Apparatus_Tof-grad.pdf}
\end{center}
...
% add magnetic field spatial distribution
\begin{figure}[htbp]
\begin{center}
\includegraphics [width = \linewidth]{Apparatus_mag-field.pdf}
\end{center}
\caption[Fast coil, main coil and environment]{}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics [width = \linewidth]{Apparatus_gradient-compen.pdf}
\end{center}
\caption[]{}
...
% add find compensation point method
\begin{figure}[htbp]
\begin{center}
\includegraphics [width = \linewidth]{Apparatus_compen_method.pdf}
\end{center}
\caption[]{}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics [width = \linewidth]{Apparatus_mag_before_after.pdf}
\end{center}
\caption[]{}
...
% full-loop antenna: 示意图 和 电磁场分布
\begin{figure}[htb]
\begin{center}
\includegraphics [width =0.5 \linewidth]{Apparatus-.pdf}
\end{center}
\caption[]{}  
...
% full-loop and small-loop antenna
\begin{figure}[htb]
\begin{center}
\includegraphics [width =0.5 \linewidth]{Apparatus-.pdf}
\end{center}
...
% test the SWR by directional coupler
\begin{figure}[htb]
\begin{center}
...
\begin{figure}[htb]
\begin{center}
\includegraphics [width =0.7 \linewidth]{Apparatus-loop_antenna_return_loss.pdf}
\end{center}
\caption[]{}  
